...
public class NoteController {
   private final NoteService noteService;
    ...
    @PostMapping
    public ResponseEntity<NoteReadDto> createNote(@Valid @RequestBody NoteCreateDto dto, @RequestParam Long ownerId /*Extract the owner id from the param*/) {
    ...
    @GetMapping
    public Page<NoteReadDto> list(@RequestParam Long ownerId, //?ownerId=123
